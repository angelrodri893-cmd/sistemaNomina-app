...
namespace SistemaNominaAPPWeb.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeptNo,DeptName,IsActive")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeptNo,DeptName,IsActive")] Department department)
        {
